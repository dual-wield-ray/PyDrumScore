...
def chorus():
    for i in range(8):
        ...
        if i % 4 == 3:
            m.sd += note_range(3.5, pds.end(), 0.25)
            m.hh = [hh for hh in m.hh if hh not in note_range(3.5, pds.end(), 0.5)]
        elif i % 4 == 0:
            m.replace(m.hh, m.c1, [1])
        elif i % 2:
            m.replace(m.hh, m.ho, [4.5])
...
for i in range(4):
    m = Measure(
        ...
        sd=[2, 4] + note_range(3.5, pds.end(), 0.25),
        bd=[1, 2, 3, 4],
    )
    if i == 3:
        m = Measure(fm=[1, 2, 3, 4], bd=[1.5, 2.5, 3.5, 4.25])

    measures += m

# Stop! Wait a minute
measures += Measure(sd=[1], hh=[1], fm=[4], bd=[4.25])
...
for i in range(4):
    ...
    if i == 3:
        m = Measure(sd=[1, 2, 3, 4], ho=[1, 2, 3, 4], bd=[1.5, 2.5, 3.5, 4.25])
...
for i in range(16):
    m = Measure(
        rd=note_range(1, pds.end(), 1),
        rb=note_range(1.5, pds.end(), 1),
        sd=[2, 4],
        bd=[1, 2, 3, 4],
    )
    ...
    if i == 7:
        m = Measure(ho=[1], sd=[1.5], fm=[2, 3, 4], bd=[1, 2.5, 3.5, 4.25])
    elif i == 11:
        m = Measure(
            sd=note_range(1, 3, 0.5) + note_range(3, pds.end(), 0.25),
            bd=[1, 2, 3, 4],
        )

    elif i == 15:
        m = Measure(sd=note_range(1, 4.25, 0.25, excl=[2, 2.5, 3.5, 3.75]))
